...
'public' => true,
'has_archive' => true,
'taxonomies'    => array('post_tag'), // nếu các bạn muốn tag cho các chương của mình <img src="http://thachpham.com/wp-includes/images/smilies/icon_razz.gif" alt=":P" class="wp-smiley">
